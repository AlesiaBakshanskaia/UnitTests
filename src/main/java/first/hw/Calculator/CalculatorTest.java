...
//        double price = Calculator.calculatingDiscount(56,-1);
//        System.out.println(price);
        assertThat(Calculator.calculatingDiscount(60, 10)).isEqualTo(54);
        assertThat(Calculator.calculatingDiscount(60, 0)).isEqualTo(60);
        assertThat(Calculator.calculatingDiscount(60, 100)).isEqualTo(0);
        assertThat(Calculator.calculatingDiscount(60, 1)).isEqualTo(59.4);
        assertThatThrownBy(() ->
                Calculator.calculatingDiscount(60, -1)
        ).isInstanceOf(ArithmeticException.class);
        assertThatThrownBy(() ->
                Calculator.calculatingDiscount(60, 101)
        ).isInstanceOf(ArithmeticException.class);
